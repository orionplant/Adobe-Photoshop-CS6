...
5. Go to Compatibility -> Windows Version -> Windows 8
6. In Bottle go to Change Launch Options... -> VKD3D -> Off
7. Then run executable from your unzip folder
8. After installation add shortcut PhotoshopCS6Portable.exe
